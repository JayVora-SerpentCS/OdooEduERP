odoo.define('school.update_kanban', function (require) {
"use strict";
...
KanbanView.include({
    student_display_members_names: function() {
    ...
    on_groups_started: function() {
        ...
        if (self.dataset.model === 'student.news') {
...
KanbanRecord.include({
    on_card_clicked: function() {
        if (this.model === 'student.news') {
            this.$('.oe_kanban_school_list a').first().click();
        } else {
