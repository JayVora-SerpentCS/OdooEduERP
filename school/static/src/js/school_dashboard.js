...
var SchoolDashboardView = KanbanView.extend({
    ...
    render: function() {
        ...
        return this.fetch_data().then(function(result){
            ...
            var school_dashboard = QWeb.render('school.SchoolDashboard', {
                widget: self,
    ...
    on_change_input_target: function(e) {
        ...
        if(isNaN(target_value)) {
            ...
            this._updated = new Model('crm.lead')
                            .call('modify_target_school_dashboard', [target_name, target_value])
                            .then(function() {
                                return self.render();
                            });
        }
...
core.view_registry.add('school_dashboard', SchoolDashboardView);
