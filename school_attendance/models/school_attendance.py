...
class AttendanceSheet(models.Model):
    ...
    def fields_view_get(
        ...
        """Method to display month wise days as per selected month"""
...
class AttendanceSheetLine(models.Model):
    ...
    name = fields.Char(
        "Student Name", required=True, readonly=True, help="Enter student name"
    )
...
class DailyAttendanceLine(models.Model):
    ...
    standard_id = fields.Many2one(
        "daily.attendance", "Standard", help="Enter standard for attendance"
    )
    stud_id = fields.Many2one("student.student", "Name", help="Select student")
    ...
    present_absentcheck = fields.Boolean(
        "Present/Absent Boolean", help="Check for present/absent"
    )
